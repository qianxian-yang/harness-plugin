...
This document describes the structure and format of td-harness skill files. Use this as a guide when contributing new skills or understanding existing ones.
...
If the request is API-heavy, also apply `api-and-interface-design`.
```
