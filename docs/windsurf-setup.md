# Using td-harness with Windsurf
...
cat /path/to/td-harness/skills/test-driven-development/SKILL.md > .windsurfrules
echo "\n---\n" >> .windsurfrules
cat /path/to/td-harness/skills/context-engineering/SKILL.md >> .windsurfrules
echo "\n---\n" >> .windsurfrules
cat /path/to/td-harness/skills/code-review-and-quality/SKILL.md >> .windsurfrules
```
...
```
# .windsurfrules
# Essential td-harness for this project

[Paste test-driven-development SKILL.md]

---

[Paste context-engineering SKILL.md]
...
2. **Reference in conversation** — Paste additional skill content into the chat when working on specific workflows (e.g., paste `security-and-hardening` when building auth).
