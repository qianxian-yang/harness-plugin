# Using td-harness with GitHub Copilot
...
cat /path/to/td-harness/skills/test-driven-development/SKILL.md > .github/skills/test-driven-development/SKILL.md
cat /path/to/td-harness/skills/code-review-and-quality/SKILL.md > .github/skills/code-review-and-quality/SKILL.md
```
...
Copilot supports specialized agent personas. Use the td-harness agents:

```bash
# Copy agent definitions
cp /path/to/td-harness/agents/code-reviewer.md .github/agents/code-reviewer.md
cp /path/to/td-harness/agents/test-engineer.md .github/agents/test-engineer.md
cp /path/to/td-harness/agents/security-auditor.md .github/agents/security-auditor.md
```
...
3. **Reference in chat** — When working on a specific workflow, paste the relevant skill content into Copilot Chat for context.
