...
is generated by downstream execution/verification workflows at task runtime
based on environment.json + task context (which files changed, what the task was).
...
### Next Steps
{For empty projects: "Implement business/application code using your standard delivery workflow."}
