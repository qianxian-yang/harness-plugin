...
adapter:
  ...
  commands:
    build: "mvn -B clean install -DskipTests -U"
    test: null    # Detected from build tool
    lint: "mvn com.github.spotbugs:spotbugs-maven-plugin:4.9.8.3:spotbugs"
    lint_arch: null
    format: null
    start: null
    dev: null
  ...
  linter:
    ...
    quality_setup_commands: null
    quality_run_commands:
      - "mvn -B clean install -DskipTests -U"
      - "JAVA_VERSION>8: mvn com.github.spotbugs:spotbugs-maven-plugin:4.9.8.3:spotbugs"
      - "JAVA_VERSION<=8: mvn com.github.spotbugs:spotbugs-maven-plugin:4.7.3.6:spotbugs"
