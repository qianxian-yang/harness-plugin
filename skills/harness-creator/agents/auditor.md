...
| ARCHITECTURE.md exists | `test -f harness/docs/ARCHITECTURE.md` | File exists |
| ARCHITECTURE.md has Mermaid diagrams | `grep 'mermaid' harness/docs/ARCHITECTURE.md` | At least 1 |
...
| Design docs exist (not just index) | `find harness/docs/design-docs -name "*.md" ! -name "index.md"` | ≥ 2 files |
...
| Check | How | Pass Criteria |
|-------|-----|---------------|
| lint-deps script exists | `test -f harness/lint-scripts/lint-deps*` | File exists |
| lint-quality script exists | `test -f harness/lint-scripts/lint-quality*` | File exists |
...
| Check | How | Pass Criteria |
|-------|-----|---------------|
| harness/Makefile has lint-arch target | `grep 'lint-arch' harness/Makefile` | Target exists |
